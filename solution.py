...
class PCA():
    ...
    def _do_pca(self):
        ...
        # computing data centered matrx, X_tilde
        ...
        # performing SVD on X_tilde
        U,_,_= np.linalg.svd(X_tilde)

        # selecting principal components from U matrix
        Up = U[:,:self.n_components]

        # Computing the reduced data matrix from principal components chosen earilier
...
class AE(nn.Module):
    ...
    def _forward(self, X):
        ...
        # transposing the input to maintain the traditional way of inputs to a neural net
    ...
    def reconstruction(self, X):
        ...
        with torch.no_grad():
            for i in range(n_samples):
                ...
                if i==0:
                    # initialize X_re with curr_X_re_tensor
